...
class Crud_Core_Route extends Kohana_Route {
	...
	public static function set_crud($route_name, $uri_prefix, $controller, $skip_show = false,  $guid='id', $guid_regex = Route::REGEX_SEGMENT, $per_page = 50, $except = array()) {
